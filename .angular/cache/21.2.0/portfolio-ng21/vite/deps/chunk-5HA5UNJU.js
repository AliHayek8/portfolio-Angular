...
function ToolBarComponent_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵconditionalCreate(0, ToolBarComponent_Conditional_1_Conditional_0_Template, 2, 8, "span", 17);
    ɵɵconditionalCreate(1, ToolBarComponent_Conditional_1_Conditional_1_Template, 6, 16, "div", 18);
...
function ToolBarComponent_Conditional_6_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵconditionalCreate(3, ToolBarComponent_Conditional_6_Conditional_3_Template, 6, 16, "div", 18);
  }
  if (rf & 2) {
    const ctx_r1 = ɵɵnextContext();
    ɵɵadvance(2);
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    consts: () => {
      ...
      if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
        const MSG__USERS_ALIHAYEK_DESKTOP_PORTFOLIO_FIXED_NODE_MODULES__PROGRESS_KENDO_ANGULAR_TOOLBAR_FESM2022_PROGRESS_KENDO_ANGULAR_TOOLBAR_MJS_0 = goog.getMsg("More tools");
        i18n_0 = MSG__USERS_ALIHAYEK_DESKTOP_PORTFOLIO_FIXED_NODE_MODULES__PROGRESS_KENDO_ANGULAR_TOOLBAR_FESM2022_PROGRESS_KENDO_ANGULAR_TOOLBAR_MJS_0;
      } else {
        i18n_0 = $localize`:kendo.toolbar.moreToolsTitle|The title of the **more tools** button in a responsive ToolBar:More tools`;
      }
      let i18n_1;
      if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
        const MSG__USERS_ALIHAYEK_DESKTOP_PORTFOLIO_FIXED_NODE_MODULES__PROGRESS_KENDO_ANGULAR_TOOLBAR_FESM2022_PROGRESS_KENDO_ANGULAR_TOOLBAR_MJS_1 = goog.getMsg("Scroll left");
        i18n_1 = MSG__USERS_ALIHAYEK_DESKTOP_PORTFOLIO_FIXED_NODE_MODULES__PROGRESS_KENDO_ANGULAR_TOOLBAR_FESM2022_PROGRESS_KENDO_ANGULAR_TOOLBAR_MJS_1;
      } else {
      ...
      let i18n_2;
      if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
        const MSG__USERS_ALIHAYEK_DESKTOP_PORTFOLIO_FIXED_NODE_MODULES__PROGRESS_KENDO_ANGULAR_TOOLBAR_FESM2022_PROGRESS_KENDO_ANGULAR_TOOLBAR_MJS_2 = goog.getMsg("Scroll right");
        i18n_2 = MSG__USERS_ALIHAYEK_DESKTOP_PORTFOLIO_FIXED_NODE_MODULES__PROGRESS_KENDO_ANGULAR_TOOLBAR_FESM2022_PROGRESS_KENDO_ANGULAR_TOOLBAR_MJS_2;
      } else {
      ...
      return [["popupTemplate", ""], ["popupSectionTemplate", ""], ["container", ""], ["scrollSeparator", ""], ["prevScrollButton", ""], ["startButtonGroup", ""], ["nextScrollButton", ""], ["scrollContainer", ""], ["wrapper", ""], ["overflowButton", ""], ["endButtonGroup", ""], ["popupWrapper", ""], ["resizeSensor", ""], ["kendoToolbarLocalizedMessages", "", "moreToolsTitle", i18n_0, "previousToolButton", i18n_1, "nextToolButton", i18n_2], ["tabindex", "-1", 1, "k-toolbar-items", "k-toolbar-items-scroll"], [1, "k-toolbar-separator", "k-toolbar-button-separator", "k-separator"], ["kendoButton", "", "fillMode", "flat", "type", "button", "tabindex", "-1", 1, "k-toolbar-overflow-button", 3, "icon", "svgIcon", "title", "id", "visibility", "position", "ngClass"], ["kendoToolbarScrollableButton", "", 1, "k-toolbar-prev", "k-icon-button", "k-button", 3, "prev", "overflow", "title", "ngClass"], [1, "k-button-group"], ["kendoToolbarScrollableButton", "", 1, "k-toolbar-prev", "k-icon-button", "k-button", 3, "onClick", "prev", "overflow", "title", "ngClass"], ["kendoToolbarScrollableButton", "", 1, "k-toolbar-next", "k-icon-button", "k-button", 3, "onClick", "prev", "overflow", "title", "ngClass"], ["kendoToolbarRenderer", "", "location", "toolbar", 3, "tool", "resizable", "ngTemplateOutlet"], ["kendoToolbarRenderer", "", "location", "toolbar", 3, "rendererClick", "tool", "resizable", "ngTemplateOutlet"], [1, "k-toolbar-item"], [3, "ngTemplateOutlet"], ["kendoButton", "", "fillMode", "flat", "type", "button", "tabindex", "-1", 1, "k-toolbar-overflow-button", 3, "click", "icon", "svgIcon", "title", "id", "ngClass"], ["kendoToolbarScrollableButton", "", 1, "k-toolbar-next", "k-icon-button", "k-button", 3, "prev", "overflow", "title", "ngClass"], ["role", "menu", 1, "k-menu-group", 3, "id"], ["kendoToolbarRenderer", "", "location", "overflow", 3, "tool", "resizable", "ngTemplateOutlet"], ["kendoToolbarRenderer", "", "location", "overflow", 3, "rendererClick", "tool", "resizable", "ngTemplateOutlet"], ["role", "menuitem", "tabindex", "-1", 1, "k-item", "k-menu-item"], ["role", "toolbar", 1, "k-toolbar-items-list", "k-toolbar-items-list-solid", 3, "ngClass", "id"], ["kendoToolbarRenderer", "", "location", "section", 3, "tool", "resizable", "ngTemplateOutlet"], ["kendoToolbarRenderer", "", "location", "section", 3, "rendererClick", "tool", "resizable", "ngTemplateOutlet"]];
    },
...
//# sourceMappingURL=chunk-5HA5UNJU.js.map

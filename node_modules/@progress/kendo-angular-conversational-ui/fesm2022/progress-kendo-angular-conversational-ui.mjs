...
import { ButtonComponent, FloatingActionButtonComponent, SpeechToTextButtonComponent, DropDownButtonComponent, KENDO_BUTTONS, ButtonsModule, KENDO_BUTTON } from '@progress/kendo-angular-buttons';
 ...
 * @hidden
 */
let Messages$3 = class Messages extends ComponentMessages {
    /**
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.18", ngImport: i0, type: Messages$3, decorators: [{
            type: Directive
 ...
 * @hidden
 */
let LocalizedMessagesDirective$3 = class LocalizedMessagesDirective extends Messages$3 {
    service;
    constructor(service) {
        super();
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.18", ngImport: i0, type: LocalizedMessagesDirective$3, decorators: [{
            type: Directive,
            args: [{
                    providers: [
                        {
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.18", ngImport: i0, type: AIPromptComponent, decorators: [{
        ...
        `,
                    standalone: true,
                    imports: [LocalizedMessagesDirective$3, ButtonComponent, AIPromptToolbarFocusableDirective, NgTemplateOutlet, FloatingActionButtonComponent]
                }]
 ...
 * ```
 */
class AIPromptCustomMessagesComponent extends Messages$3 {
    service;
    constructor(service) {
        super();
        this.service = service;
...
const parseMessage = (message, fields) => {
    ...
    return {
        ...
        failed: getter(modelFields.failedField)(message),
        dataItem: message
    };
};
/**
...
class ChatService {
    ...
    resendMessage$ = this.subjects.resendMessage.asObservable();
...
class SuggestedActionsComponent extends ChatItem {
    ...
    get scrollStartClass() {
        return this.isScrollable && !this.isAtScrollEnd;
    }
    get scrollEndClass() {
        return this.isScrollable && !this.isAtScrollStart;
    }
    get role() {
    ...
    get hasScrollButtons() {
        return this.type === 'suggestion'
            ? this.chatService.suggestionsLayout === 'scrollbuttons'
    ...
    onScrollableContainerScroll(_event) {
        this.updateScrollableState();
    }
    scrollSuggestions(direction) {
    ...
    updateScrollableState() {
        ...
        this.isAtScrollStart = scrollLeft <= 0;
        this.isAtScrollEnd = maxScroll <= 0 || scrollLeft >= maxScroll - 1;
    }
    toggleScrollButtonState(buttonType, active) {
        ...
        if (buttonType === 'prev') {
            this.isAtScrollStart = !active;
        }
        else if (buttonType === 'next') {
            this.isAtScrollEnd = !active;
        }
    }
    ...
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "19.2.18", type: SuggestedActionsComponent, isStandalone: true, selector: "kendo-chat-suggested-actions", inputs: { actions: "actions", suggestions: "suggestions", tabbable: "tabbable", type: "type", suggestionTemplate: "suggestionTemplate" }, outputs: { dispatchAction: "dispatchAction", dispatchSuggestion: "dispatchSuggestion" }, host: { properties: { "class.k-suggestion-group": "this.defaultClass", "class.k-suggestion-group-scrollable": "this.scrollableClass", "class.k-suggestion-scrollwrap": "this.scrollButtonsClass", "class.k-suggestion-group-scrollable-start": "this.scrollStartClass", "class.k-suggestion-group-scrollable-end": "this.scrollEndClass", "attr.role": "this.role" } }, providers: [
        ...
        ], viewQueries: [{ propertyName: "suggestionsContainer", first: true, predicate: ["suggestionsContainer"], descendants: true, read: ElementRef }, { propertyName: "scrollableContainer", first: true, predicate: ["scrollableContainer"], descendants: true, read: ElementRef }, { propertyName: "prevScrollButton", first: true, predicate: ["prevScrollButton"], descendants: true, read: ElementRef }, { propertyName: "nextScrollButton", first: true, predicate: ["nextScrollButton"], descendants: true, read: ElementRef }, { propertyName: "items", predicate: ["item"], descendants: true }], usesInheritance: true, ngImport: i0, template: `
        @if (hasScrollButtons) {
        <span
            #prevScrollButton
            ...
            class="k-button k-button-sm k-button-flat k-icon-button"
        ...
        <div class="k-suggestion-group" 
            role="group"
            [class.k-suggestion-group-scrollable-start]="!isAtScrollEnd"
            [class.k-suggestion-group-scrollable-end]="!isAtScrollStart">
            <div #suggestionsContainer class="k-suggestions-scroll" (scroll)="onScroll($event)">
                <ng-container *ngTemplateOutlet="suggestionsContent"></ng-container>
            </div>
        </div>
        } @else { @if (isScrollable) {
        <div #scrollableContainer class="k-suggestions-scroll" (scroll)="onScrollableContainerScroll($event)">
            <ng-container *ngTemplateOutlet="suggestionsContent"></ng-container>
        </div>
        } @else {
        <ng-container *ngTemplateOutlet="suggestionsContent"></ng-container>
        ...
        <ng-template #suggestionsContent>
            @if (actions) { @for (action of actions; track action; let index = $index; let first = $first; let last =
            $last) {
            <span
                #item
            ...
            } } @if (suggestions) { @if (!suggestionTemplate?.templateRef) { @for (suggestion of suggestions; track
            suggestion; let index = $index; let first = $first; let last = $last) {
            <span
                #item
                class="k-suggestion"
                role="button"
            ...
            } } @if (suggestionTemplate?.templateRef) { @for (suggestion of suggestions; track suggestion) {
            <ng-template
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.18", ngImport: i0, type: SuggestedActionsComponent, decorators: [{
    ...
    `,
                ...
                type: HostBinding,
                args: ['class.k-suggestion-group-scrollable-start']
            }], scrollEndClass: [{
                type: HostBinding,
                args: ['class.k-suggestion-group-scrollable-end']
            }], role: [{
                type: HostBinding,
                args: ['attr.role']
            }], actions: [{
...
class ChatFileComponent extends ChatItem {
    ...
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "19.2.18", type: ChatFileComponent, isStandalone: true, selector: "li[chatFile]", inputs: { chatFile: "chatFile", removable: "removable", fileActions: "fileActions" }, outputs: { remove: "remove", actionClick: "actionClick", actionsToggle: "actionsToggle", actionButtonClick: "actionButtonClick" }, providers: [{
        ...
        <div class="k-file-info">
          <span class="k-file-name">{{chatFile.name}}</span>
          <span class="k-file-size">{{getTotalFilesSizeMessage(chatFile)}}</span>
        </div>
        @if (removable) {
          <button
            kendoButton
...
class MessageReferenceComponent extends ChatItem {
    ...
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "19.2.18", type: MessageReferenceComponent, isStandalone: true, selector: "chat-message-reference-content", inputs: { message: "message" }, host: { properties: { "class.k-message-reference-content": "this.hostClass" } }, providers: [{
        ...
        @if (!message.text && !message.isDeleted && message.files && message.files.length > 0) {
          <li class="k-file-box" [chatFile]="message.files[0]">
          </li>
        }
 ...
 * ```
 */
class PromptBoxEndAffixComponent {
    /**
     * @hidden
     */
    templateRef;
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.18", ngImport: i0, type: PromptBoxEndAffixComponent, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "19.2.18", type: PromptBoxEndAffixComponent, isStandalone: true, selector: "kendo-promptbox-end-affix", viewQueries: [{ propertyName: "templateRef", first: true, predicate: ["template"], descendants: true, static: true }], exportAs: ["kendoPromptBoxEndAffix"], ngImport: i0, template: `<ng-template #template><ng-content></ng-content></ng-template>`, isInline: true });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.18", ngImport: i0, type: PromptBoxEndAffixComponent, decorators: [{
            type: Component,
            args: [{
 ...
 * ```
 */
class PromptBoxStartAffixComponent {
    /**
     * @hidden
     */
    templateRef;
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.18", ngImport: i0, type: PromptBoxStartAffixComponent, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "19.2.18", type: PromptBoxStartAffixComponent, isStandalone: true, selector: "kendo-promptbox-start-affix", viewQueries: [{ propertyName: "templateRef", first: true, predicate: ["template"], descendants: true, static: true }], exportAs: ["kendoPromptBoxStartAffix"], ngImport: i0, template: `<ng-template #template><ng-content></ng-content></ng-template>`, isInline: true });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.18", ngImport: i0, type: PromptBoxStartAffixComponent, decorators: [{
            type: Component,
            args: [{
 ...
 * ```
 */
class PromptBoxTopAffixComponent {
    /**
     * @hidden
     */
    templateRef;
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.18", ngImport: i0, type: PromptBoxTopAffixComponent, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "19.2.18", type: PromptBoxTopAffixComponent, isStandalone: true, selector: "kendo-promptbox-top-affix", viewQueries: [{ propertyName: "templateRef", first: true, predicate: ["template"], descendants: true, static: true }], exportAs: ["kendoPromptBoxTopAffix"], ngImport: i0, template: `<ng-template #template><ng-content></ng-content></ng-template>`, isInline: true });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.18", ngImport: i0, type: PromptBoxTopAffixComponent, decorators: [{
            type: Component,
            args: [{
 ...
 * @hidden
 */
class PromptBoxHeaderTemplateDirective {
    templateRef;
    constructor(templateRef) {
        this.templateRef = templateRef;
    }
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.18", ngImport: i0, type: PromptBoxHeaderTemplateDirective, deps: [{ token: i0.TemplateRef, optional: true }], target: i0.ɵɵFactoryTarget.Directive });
    static ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "14.0.0", version: "19.2.18", type: PromptBoxHeaderTemplateDirective, isStandalone: true, selector: "[kendoPromptBoxHeaderTemplate]", ngImport: i0 });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.18", ngImport: i0, type: PromptBoxHeaderTemplateDirective, decorators: [{
            type: Directive,
            args: [{
 ...
 * @hidden
 */
const FILESELECT_BUTTON_DEFAULT_SETTINGS = {
    disabled: false,
    fillMode: 'flat',
    size: 'small',
    rounded: 'full',
...
let Messages$2 = class Messages extends ComponentMessages {
    ...
    messageBoxTitle;
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.18", ngImport: i0, type: Messages, deps: null, target: i0.ɵɵFactoryTarget.Directive });
    static ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "14.0.0", version: "19.2.18", type: Messages, isStandalone: true, inputs: { fileSelectButtonTitle: "fileSelectButtonTitle", actionButtonTitle: "actionButtonTitle", stopGeneratingTitle: "stopGeneratingTitle", speechToTextButtonTitle: "speechToTextButtonTitle", removeFileTitle: "removeFileTitle", messageBoxTitle: "messageBoxTitle" }, usesInheritance: true, ngImport: i0 });
};
...
let LocalizedMessagesDirective$2 = class LocalizedMessagesDirective extends Messages$2 {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.18", ngImport: i0, type: LocalizedMessagesDirective, deps: [{ token: i1.LocalizationService }], target: i0.ɵɵFactoryTarget.Directive });
    static ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "14.0.0", version: "19.2.18", type: LocalizedMessagesDirective, isStandalone: true, selector: "[kendoPromptBoxLocalizedMessages]", providers: [
            {
                provide: Messages$2,
                useExisting: forwardRef(() => LocalizedMessagesDirective)
            }
...
class PromptBoxBaseTool {
    ...
    _size;
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.18", ngImport: i0, type: PromptBoxBaseTool, deps: [], target: i0.ɵɵFactoryTarget.Directive });
    static ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "14.0.0", version: "19.2.18", type: PromptBoxBaseTool, isStandalone: true, inputs: { disabled: "disabled", fillMode: "fillMode", icon: "icon", iconClass: "iconClass", imageUrl: "imageUrl", svgIcon: "svgIcon", rounded: "rounded", size: "size", themeColor: "themeColor", title: "title" }, outputs: { sizeChange: "sizeChange" }, ngImport: i0 });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.18", ngImport: i0, type: PromptBoxBaseTool, decorators: [{
            type: Directive
 ...
 * ```
 */
class PromptBoxActionButtonComponent extends PromptBoxBaseTool {
    localization;
    /**
     * @hidden
     */
     ...
     */
    handleClick() {
        const actionType = this.loading ? 'stop' : 'send';
        this.promptAction.emit({ actionType });
    }
    /**
     * @hidden
     */
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.18", ngImport: i0, type: PromptBoxActionButtonComponent, deps: [{ token: i1.LocalizationService }], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "19.2.18", type: PromptBoxActionButtonComponent, isStandalone: true, selector: "kendo-promptbox-action-button", inputs: { buttonClass: "buttonClass", loading: "loading", loadingIcon: "loadingIcon", loadingSVGIcon: "loadingSVGIcon" }, outputs: { promptAction: "promptAction" }, providers: [
            {
                provide: PromptBoxBaseTool,
                useExisting: forwardRef(() => PromptBoxActionButtonComponent),
            },
        ], exportAs: ["kendoPromptBoxActionButton"], usesInheritance: true, ngImport: i0, template: `
        <button
            kendoButton
            [class]="buttonClass"
            ...
            [svgIcon]="loading ? loadingSVGIcon : svgIcon"
            [disabled]="disabled"
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.18", ngImport: i0, type: PromptBoxActionButtonComponent, decorators: [{
            type: Component,
            args: [{
                    exportAs: 'kendoPromptBoxActionButton',
                    selector: 'kendo-promptbox-action-button',
                    providers: [
                        {
                            provide: PromptBoxBaseTool,
                            useExisting: forwardRef(() => PromptBoxActionButtonComponent),
 ...
 * ```
 */
class PromptBoxFileSelectButtonComponent extends PromptBoxBaseTool {
    localization;
    /**
     * @hidden
     */
     ...
     */
    handleSelect(event) {
        const allowedFiles = event.files.filter((file) => !file.validationErrors);
        event.files = allowedFiles;
        this.selectAttachments.emit(event);
    }
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.18", ngImport: i0, type: PromptBoxFileSelectButtonComponent, deps: [{ token: i1.LocalizationService }], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "19.2.18", type: PromptBoxFileSelectButtonComponent, isStandalone: true, selector: "kendo-promptbox-fileselect-button", inputs: { restrictions: "restrictions", multiple: "multiple", accept: "accept" }, outputs: { selectAttachments: "selectAttachments" }, providers: [
            {
                provide: PromptBoxBaseTool,
                useExisting: forwardRef(() => PromptBoxFileSelectButtonComponent),
            },
        ], viewQueries: [{ propertyName: "fileSelectComponent", first: true, predicate: ["fileSelect"], descendants: true }], exportAs: ["kendoPromptBoxFileSelectButton"], usesInheritance: true, ngImport: i0, template: `
        <button
            kendoButton
            [attr.aria-label]="title || textFor('fileSelectButtonTitle')"
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.18", ngImport: i0, type: PromptBoxFileSelectButtonComponent, decorators: [{
            type: Component,
            args: [{
...
class PromptBoxFileComponent {
    ...
    focus() { }
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.18", ngImport: i0, type: PromptBoxFileComponent, deps: [{ token: i1.LocalizationService }], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "19.2.18", type: PromptBoxFileComponent, isStandalone: true, selector: "li[promptBoxFile]", inputs: { promptBoxFile: "promptBoxFile", removable: "removable", fileActions: "fileActions", disabled: "disabled" }, outputs: { remove: "remove" }, ngImport: i0, template: `
        <kendo-icon-wrapper
          size="xlarge"
          [name]="fileGroupClass(promptBoxFile.extension)"
          [svgIcon]="fileThumbnail(promptBoxFile.extension)"
          >
        </kendo-icon-wrapper>
        <div class="k-file-info">
          <span class="k-file-name">{{promptBoxFile.name}}</span>
          <span class="k-file-size">{{getTotalFilesSizeMessage(promptBoxFile)}}</span>
        </div>
        @if (removable) {
          <button
            kendoButton
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.18", ngImport: i0, type: PromptBoxFileComponent, decorators: [{
            type: Component,
            args: [{
 ...
 * ```
 */
class PromptBoxSpeechToTextButtonComponent extends PromptBoxBaseTool {
    localization;
    /**
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.18", ngImport: i0, type: PromptBoxSpeechToTextButtonComponent, deps: [{ token: i1.LocalizationService }], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "19.2.18", type: PromptBoxSpeechToTextButtonComponent, isStandalone: true, selector: "kendo-promptbox-speech-to-text-button", inputs: { continuous: "continuous", integrationMode: "integrationMode", interimResults: "interimResults", lang: "lang", maxAlternatives: "maxAlternatives" }, outputs: { stbClick: "stbClick", stbStart: "stbStart", stbEnd: "stbEnd", stbError: "stbError", stbResult: "stbResult" }, providers: [
            {
                provide: PromptBoxBaseTool,
                useExisting: forwardRef(() => PromptBoxSpeechToTextButtonComponent),
            },
        ], exportAs: ["kendoPromptBoxSpeechToTextButton"], usesInheritance: true, ngImport: i0, template: `
        <button
            kendoSpeechToTextButton
            [attr.aria-label]="title || textFor('speechToTextButtonTitle')"
            [attr.title]="title || textFor('speechToTextButtonTitle')"
            ...
            [size]="size"
            [themeColor]="themeColor"
            (click)="stbClick.emit($event)"
            (start)="stbStart.emit($event)"
            (end)="stbEnd.emit($event)"
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.18", ngImport: i0, type: PromptBoxSpeechToTextButtonComponent, decorators: [{
            type: Component,
            args: [{
                    exportAs: 'kendoPromptBoxSpeechToTextButton',
                    selector: 'kendo-promptbox-speech-to-text-button',
                    providers: [
                        {
                            provide: PromptBoxBaseTool,
                            useExisting: forwardRef(() => PromptBoxSpeechToTextButtonComponent),
...
class PromptBoxComponent {
    ...
    get hostMultilineClass() {
        return this.mode === 'multi' || (this.mode === 'auto' && this.hasExpanded);
    }
     ...
     */
    speechToTextClick = new EventEmitter();
    /**
     * Fires each time the speech recognition service begins listening to incoming audio.
     */
    speechToTextStart = new EventEmitter();
    /**
     * Fires each time the speech recognition service disconnects.
     */
    speechToTextEnd = new EventEmitter();
    /**
     * Fires when a speech recognition error occurs.
     */
    speechToTextError = new EventEmitter();
    /**
     * Fires when the speech recognition service returns a result.
     */
    speechToTextResult = new EventEmitter();
    /**
     * @hidden
     */
    inputElement;
    ...
    get isActionButtonDisabled() {
        ...
        if (isPresent(this.actionButtonSettings?.disabled)) {
            return this.actionButtonSettings.disabled;
        }
        const isEmptyInput = !this.value?.length || !this.value?.trim();
    ...
    fileSelectSubscription = new Subscription();
    ...
    ngAfterViewInit() {
        ...
        this.subscribeToFileSelectButton();
    }
    ngOnDestroy() {
        if (this.resizeSubscription) {
            this.resizeSubscription.unsubscribe();
        }
        if (this.speechToTextSubscription) {
            this.speechToTextSubscription.unsubscribe();
        }
        if (this.actionButtonSubscription) {
    ...
    handleKeydown = (event) => {
        if (event.key === 'Enter' && !event.shiftKey) {
            ...
            if (!this.loading && !this.isActionButtonDisabled) {
                this.ngZone.run(() => {
                    this.handlePromptAction({ actionType: 'send' });
                });
            }
        }
    };
    ...
    handlePromptAction(event) {
        if (hasObservers(this.promptAction)) {
            this.promptAction.emit(event);
        }
        if (event.actionType === 'send') {
            this.value = '';
            this.ngChange(this.value);
            this.valueChange.emit(this.value);
        }
     ...
     * @hidden
     */
    handleFileSelectAttachments(event) {
     ...
     * @hidden
     */
    onFilesListScroll(filesList) {
        this.checkFilesListScroll(filesList);
    }
    /**
     * @hidden
     */
    handleSpeechToTextClick(event) {
        if (hasObservers(this.speechToTextClick)) {
            this.speechToTextClick.emit(event);
        }
    }
    /**
     * @hidden
     */
    handleSpeechToTextStart(event) {
     ...
     * @hidden
     */
    handleSpeechToTextError(event) {
        if (hasObservers(this.speechToTextError)) {
            this.speechToTextError.emit(event);
        }
    }
    /**
     * @hidden
     */
    handleSpeechToTextResult(event) {
        if (hasObservers(this.speechToTextResult)) {
            this.speechToTextResult.emit(event);
        }
        if (event?.alternatives?.length > 0) {
            const transcript = event.alternatives[0].transcript;
            const newValue = this.value ? `${this.value} ${transcript}`.trim() : transcript;
            this.value = newValue;
            this.ngChange(this.value);
            this.valueChange.emit(this.value);
        }
    ...
    attachResizeHandler() {
        this.resizeSubscription = fromEvent(window, 'resize')
            ...
            if (!this.hasExpanded) {
                ...
                const currentHostWidth = this.hostElement.nativeElement.offsetWidth;
                if (this.hostWidthAtCapture > 0 && currentHostWidth > 0) {
    ...
    captureInitialDimensions() {
        ...
        this.initialHeight = textarea.offsetHeight || this.singleRowHeight;
        this.singleLineWidth = textarea.offsetWidth;
        this.hostWidthAtCapture = this.hostElement.nativeElement.offsetWidth;
        this.minMultiRowHeight = lineHeight * this.rows + paddingTop + paddingBottom;
    }
    resize() {
        if (this.mode === 'single' || !this.textareaElement) {
            return;
    ...
    resizeMultiMode() {
        this.ngZone.runOutsideAngular(() => {
            ...
            const newHeight = this.calculateHeight(scrollHeight);
    ...
    shouldCollapse() {
        if (!this.textareaElement || this.singleLineWidth <= 0) {
            return false;
        }
        const textarea = this.textareaElement.nativeElement;
        const currentHeight = textarea.style.height;
        this.renderer.setStyle(textarea, 'overflow', 'hidden');
        this.renderer.setStyle(textarea, 'width', `${this.singleLineWidth}px`);
        this.renderer.setStyle(textarea, 'white-space', 'nowrap');
        this.renderer.setStyle(textarea, 'height', `${this.initialHeight}px`);
        const fitsSingleLine = textarea.scrollWidth <= this.singleLineWidth && textarea.scrollHeight <= this.initialHeight;
        this.renderer.removeStyle(textarea, 'overflow');
        this.renderer.removeStyle(textarea, 'width');
        this.renderer.removeStyle(textarea, 'white-space');
        if (currentHeight) {
            this.renderer.setStyle(textarea, 'height', currentHeight);
        }
        else {
            this.renderer.removeStyle(textarea, 'height');
        }
    ...
    calculateHeight(scrollHeight) {
        if (this.maxTextAreaHeight && scrollHeight > this.maxTextAreaHeight) {
            this.renderer.removeStyle(this.textareaElement.nativeElement, 'overflow');
            return this.maxTextAreaHeight;
        }
    ...
    subscribeToSpeechToTextButton() {
        this.speechToTextSubscription.unsubscribe();
        this.speechToTextSubscription = new Subscription();
        if (!this.speechToTextButtonComponent) {
            return;
        }
        this.speechToTextSubscription.add(this.speechToTextButtonComponent.stbClick.subscribe((event) => this.handleSpeechToTextClick(event)));
        this.speechToTextSubscription.add(this.speechToTextButtonComponent.stbStart.subscribe((event) => this.handleSpeechToTextStart(event)));
        this.speechToTextSubscription.add(this.speechToTextButtonComponent.stbEnd.subscribe((event) => this.handleSpeechToTextEnd(event)));
        this.speechToTextSubscription.add(this.speechToTextButtonComponent.stbError.subscribe((event) => this.handleSpeechToTextError(event)));
        this.speechToTextSubscription.add(this.speechToTextButtonComponent.stbResult.subscribe((event) => this.handleSpeechToTextResult(event)));
        this.speechToTextSubscription.add(this.speechToTextButtonComponent.sizeChange.subscribe(() => this.update()));
    }
    subscribeToActionButton() {
        this.actionButtonSubscription.unsubscribe();
        this.actionButtonSubscription = new Subscription();
        if (!this.actionButtonComponent) {
            return;
        }
        this.actionButtonSubscription.add(this.actionButtonComponent.promptAction.subscribe((event) => this.handlePromptAction(event)));
        this.actionButtonSubscription.add(this.actionButtonComponent.sizeChange.subscribe(() => this.update()));
    }
    subscribeToFileSelectButton() {
        this.fileSelectSubscription.unsubscribe();
        this.fileSelectSubscription = new Subscription();
        if (!this.fileSelectButtonComponent) {
            return;
        }
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.18", ngImport: i0, type: PromptBoxComponent, deps: [{ token: i0.ChangeDetectorRef }, { token: i0.Renderer2 }, { token: i0.NgZone }, { token: i1.LocalizationService }, { token: i0.ElementRef }], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "19.2.18", type: PromptBoxComponent, isStandalone: true, selector: "kendo-promptbox", inputs: { disabled: "disabled", focusableId: "focusableId", loading: "loading", placeholder: "placeholder", readonly: "readonly", title: "title", mode: "mode", rows: "rows", maxTextAreaHeight: "maxTextAreaHeight", value: "value", actionButton: "actionButton", fileSelectButton: "fileSelectButton", speechToTextButton: "speechToTextButton" }, outputs: { valueChange: "valueChange", onFocus: "focus", onBlur: "blur", inputFocus: "inputFocus", inputBlur: "inputBlur", promptAction: "promptAction", selectAttachments: "selectAttachments", fileRemove: "fileRemove", speechToTextClick: "speechToTextClick", speechToTextStart: "speechToTextStart", speechToTextEnd: "speechToTextEnd", speechToTextError: "speechToTextError", speechToTextResult: "speechToTextResult" }, host: { properties: { "class": "this.hostClasses", "class.k-prompt-box-singleline": "this.hostSinglelineClass", "class.k-prompt-box-multiline": "this.hostMultilineClass", "class.k-disabled": "this.hostDisabledClass" } }, providers: [
            LocalizationService,
            {
                provide: L10N_PREFIX,
                useValue: 'kendo.promptbox',
            },
            {
        ...
        <ng-container
            ...
            i18n-fileSelectButtonTitle="kendo.promptbox.fileSelectButtonTitle|Sets the File Select button title."
            fileSelectButtonTitle="Select attachments"
            i18n-actionButtonTitle="kendo.promptbox.actionButtonTitle|Sets the Action button title."
            actionButtonTitle="Send prompt"
            i18n-stopGeneratingTitle="kendo.promptbox.stopGeneratingTitle|Sets the Stop Generating button title."
            stopGeneratingTitle="Stop generating"
            i18n-speechToTextButtonTitle="kendo.promptbox.speechToTextButtonTitle|Sets the Speech to Text button title."
            speechToTextButtonTitle="Dictate"
            i18n-removeFileTitle="kendo.promptbox.removeFileTitle|Sets the Remove file button title."
        ...
        <ng-template #affixWithTools>
            @if(endAffix) {
            <ng-container [ngTemplateOutlet]="endAffix.templateRef"></ng-container>
            } @if(fileSelectButtonSettings) {
            <kendo-promptbox-fileselect-button
                [disabled]="disabled || fileSelectButtonSettings?.disabled"
                [fillMode]="fileSelectButtonSettings?.fillMode"
                [icon]="fileSelectButtonSettings?.icon"
                [iconClass]="fileSelectButtonSettings?.iconClass"
                [imageUrl]="fileSelectButtonSettings?.imageUrl"
                [rounded]="fileSelectButtonSettings?.rounded"
                [size]="fileSelectButtonSettings?.size"
                [svgIcon]="fileSelectButtonSettings?.svgIcon"
                [themeColor]="fileSelectButtonSettings?.themeColor"
                ...
                (selectAttachments)="handleFileSelectAttachments($event)"
            ></kendo-promptbox-fileselect-button>
            } @if(speechToTextButtonSettings) {
            <kendo-promptbox-speech-to-text-button
                [continuous]="speechToTextButtonSettings?.continuous"
                [disabled]="disabled || speechToTextButtonSettings?.disabled"
                [fillMode]="speechToTextButtonSettings?.fillMode"
                [integrationMode]="speechToTextButtonSettings?.integrationMode"
                [interimResults]="speechToTextButtonSettings?.interimResults"
                [lang]="speechToTextButtonSettings?.lang"
                [maxAlternatives]="speechToTextButtonSettings?.maxAlternatives"
                [rounded]="speechToTextButtonSettings?.rounded"
                [size]="speechToTextButtonSettings?.size"
                [themeColor]="speechToTextButtonSettings?.themeColor"
                (stbClick)="handleSpeechToTextClick($event)"
                (stbStart)="handleSpeechToTextStart($event)"
                (stbEnd)="handleSpeechToTextEnd($event)"
                (stbError)="handleSpeechToTextError($event)"
                (stbResult)="handleSpeechToTextResult($event)"
            ></kendo-promptbox-speech-to-text-button>
            } @if(actionButtonSettings) {
            <kendo-promptbox-action-button
                [disabled]="isActionButtonDisabled"
                [fillMode]="actionButtonSettings?.fillMode"
                [icon]="actionButtonSettings?.icon"
                [iconClass]="actionButtonSettings?.iconClass"
                [imageUrl]="actionButtonSettings?.imageUrl"
                [rounded]="actionButtonSettings?.rounded"
                [size]="actionButtonSettings?.size"
                [loading]="loading"
                [svgIcon]="actionButtonSettings?.svgIcon"
                [themeColor]="actionButtonSettings?.themeColor"
                [loadingIcon]="actionButtonSettings?.loadingIcon"
                [loadingSVGIcon]="actionButtonSettings?.loadingSVGIcon"
                (promptAction)="handlePromptAction($event)"
            ></kendo-promptbox-action-button>
            }
        </ng-template>

        @if(attachments.length > 0 || headerTemplate) {
        <div class="k-prompt-box-header">
        ...
        <div class="k-prompt-box-content">
            @if(startAffix) {
            <div class="k-prompt-box-affix">
                <ng-container [ngTemplateOutlet]="startAffix.templateRef"></ng-container>
            </div>
            }
            <input
                #inputElement
                class="k-prompt-box-input k-input-inner"
                [attr.aria-disabled]="disabled ? true : undefined"
                [attr.aria-readonly]="readonly ? true : undefined"
                [attr.aria-label]="textFor('messageBoxTitle')"
                [attr.title]="title"
            ...
            />
            @if(hasEndAffixContent) {
            <div class="k-prompt-box-affix">
                <ng-container [ngTemplateOutlet]="affixWithTools"></ng-container>
            </div>
            }
        </div>
        } @else {
        <div class="k-prompt-box-content">
            @if(mode === 'multi' && topAffix) {
            <div class="k-prompt-box-affix">
                <ng-container [ngTemplateOutlet]="topAffix.templateRef"></ng-container>
            </div>
            } @if(mode === 'auto' && !hasExpanded && startAffix) {
            <div class="k-prompt-box-affix">
                <ng-container [ngTemplateOutlet]="startAffix.templateRef"></ng-container>
            </div>
            }
            ...
            <textarea
                #textareaElement
                class="k-prompt-box-textarea k-input-inner"
                [attr.aria-disabled]="disabled ? true : undefined"
                [attr.aria-readonly]="readonly ? true : undefined"
                aria-multiline="true"
                [attr.aria-label]="textFor('messageBoxTitle')"
                ...
                [id]="focusableId"
                [value]="value"
                [attr.rows]="effectiveRows"
                [style.max-height.px]="maxTextAreaHeight"
                [kendoEventsOutsideAngular]="{
                    focus: handleInputFocus,
                    blur: handleInputBlur,
                    input: handleInput,
            ...
            @if(mode === 'auto' && !hasExpanded && hasEndAffixContent) {
            <div class="k-prompt-box-affix">
                <ng-container [ngTemplateOutlet]="affixWithTools"></ng-container>
            </div>
            } @if((mode === 'multi' || (mode === 'auto' && hasExpanded)) && (startAffix || hasEndAffixContent)) {
            <div class="k-prompt-box-affix">
                @if(startAffix) {
                <ng-container [ngTemplateOutlet]="startAffix.templateRef"></ng-container>
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.18", ngImport: i0, type: PromptBoxComponent, decorators: [{
            type: Component,
            args: [{
    ...
    `,
        ...
        }], ctorParameters: () => [{ type: i0.ChangeDetectorRef }, { type: i0.Renderer2 }, { type: i0.NgZone }, { type: i1.LocalizationService }, { type: i0.ElementRef }], propDecorators: { hostClasses: [{
                type: HostBinding,
                args: ['class']
            }], hostSinglelineClass: [{
                type: HostBinding,
                ...
                type: HostBinding,
                args: ['class.k-prompt-box-multiline']
            }], hostDisabledClass: [{
                type: HostBinding,
                ...
                type: ContentChild,
                args: [PromptBoxHeaderTemplateDirective]
            }], startAffix: [{
                type: ContentChild,
                args: [PromptBoxStartAffixComponent]
            }], endAffix: [{
                type: ContentChild,
                args: [PromptBoxEndAffixComponent]
            }], topAffix: [{
                type: ContentChild,
                args: [PromptBoxTopAffixComponent]
            }], speechToTextButtonComponent: [{
                type: ContentChild,
                args: [PromptBoxSpeechToTextButtonComponent, { descendants: true }]
            }], actionButtonComponent: [{
                type: ContentChild,
                args: [PromptBoxActionButtonComponent, { descendants: true }]
            }], fileSelectButtonComponent: [{
                type: ContentChild,
                args: [PromptBoxFileSelectButtonComponent, { descendants: true }]
            }] } });
 ...
 * ```
 */
class PromptBoxCustomMessagesComponent extends Messages$2 {
    service;
    constructor(service) {
        super();
        this.service = service;
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.18", ngImport: i0, type: PromptBoxCustomMessagesComponent, deps: [{ token: i1.LocalizationService }], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "19.2.18", type: PromptBoxCustomMessagesComponent, isStandalone: true, selector: "kendo-promptbox-messages", providers: [
            {
                provide: Messages$2,
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.18", ngImport: i0, type: PromptBoxCustomMessagesComponent, decorators: [{
            type: Component,
            args: [{
                    providers: [
                        {
...
class MessageBoxComponent {
    ...
    sendClick() {
        const files = this.messageBoxInput?.attachments || [];
        const hasMessage = this.inputValue?.trim() || files?.length;
        const isCustomDisabled = isPresent(this.sendButtonSettings?.disabled);
        if ((!hasMessage) && !isCustomDisabled && !this.loading) {
            return;
        }
        ...
        const message = {
            ...
            ...(processedFiles && processedFiles.length > 0 && { files: processedFiles }),
    ...
    get speechToTextButtonSettings() {
        return this.chatService.speechToTextButton;
    }
    get sendButtonSettings() {
        return this.chatService.sendButtonSettings;
    }
    get fileSelectButton() {
        return this.chatService.fileSelectButton;
    }
    get messageBoxSettings() {
        return this.chatService.messageBoxSettings;
    }
    get fileSelectButtonSettings() {
        if (typeof this.fileSelectButton === 'object' && this.fileSelectButton !== null) {
    ...
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "19.2.18", type: MessageBoxComponent, isStandalone: true, selector: "kendo-message-box", inputs: { authorId: "authorId", autoScroll: "autoScroll", suggestions: "suggestions", placeholder: "placeholder", inputValue: "inputValue", localization: "localization", messageBoxTemplate: "messageBoxTemplate", suggestionTemplate: "suggestionTemplate", loading: "loading" }, outputs: { sendMessage: "sendMessage", executeSuggestion: "executeSuggestion", fileSelect: "fileSelect", fileRemove: "fileRemove" }, host: { properties: { "style.border-color": "this.borderColor", "class.k-message-box-wrapper": "this.messageBoxWrapperClass" } }, viewQueries: [{ propertyName: "messageBoxInput", first: true, predicate: ["messageBoxInput"], descendants: true }, { propertyName: "suggestedActionsComponent", first: true, predicate: SuggestedActionsComponent, descendants: true }], ngImport: i0, template: `
        ...
        <kendo-promptbox
            #messageBoxInput
            [mode]="messageBoxSettings?.mode"
            [rows]="messageBoxSettings?.rows"
            [maxTextAreaHeight]="messageBoxSettings?.maxHeight"
            [placeholder]="placeholder || textFor('messagePlaceholder')"
            [value]="inputValue"
            (valueChange)="onInputValueChange($event)"
            (selectAttachments)="handleFileSelect($event)"
            (fileRemove)="handleFileRemove($event)"
            (promptAction)="handlePromptAction()"
            (speechToTextResult)="handleSpeechResult($event)"
            (speechToTextStart)="onSpeechToTextStart()"
            (speechToTextEnd)="onSpeechToTextEnd()"
            [actionButton]="false"
            [fileSelectButton]="false"
            [speechToTextButton]="false"
        >
            <kendo-promptbox-messages
                [fileSelectButtonTitle]="textFor('fileSelectButtonTitle')"
                [actionButtonTitle]="textFor('actionButtonTitle')"
                [speechToTextButtonTitle]="textFor('speechToTextButtonTitle')"
                [removeFileTitle]="textFor('removeFileTitle')"
                [messageBoxTitle]="textFor('messageBoxTitle')">
            </kendo-promptbox-messages>
            @if (reply) {
            <ng-template kendoPromptBoxHeaderTemplate>
...
class MessageComponent extends ChatItem {
    ...
    get isStatusString() {
        return typeof this.message?.status === 'string';
    }
    get statusObject() {
        if (this.isStatusString || !this.message?.status) {
            return null;
        }
    ...
    onExpandableKeydown(event) {
        ...
        const isFileActionButton = event.target.closest(FILE_ACTION_BTN_SELECTOR) ||
            event.target.closest(DOWNLOAD_ALL_SELECTOR);
    ...
    onResendMessage(event) {
        event.stopPropagation();
        const failedMessage = {
            message: this.message,
        };
        this.chatService.emit('resendMessage', failedMessage);
    }
    ...
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "19.2.18", type: MessageComponent, isStandalone: true, selector: "kendo-chat-message", inputs: { message: "message", tabbable: "tabbable", authorMessageContentTemplate: "authorMessageContentTemplate", receiverMessageContentTemplate: "receiverMessageContentTemplate", messageContentTemplate: "messageContentTemplate", authorMessageTemplate: "authorMessageTemplate", receiverMessageTemplate: "receiverMessageTemplate", messageTemplate: "messageTemplate", statusTemplate: "statusTemplate", showMessageTime: "showMessageTime", authorId: "authorId" }, host: { listeners: { "keydown": "onKeyDown($event)" }, properties: { "class.k-message": "this.cssClass", "class.k-message-failed": "this.failedClass", "class.k-message-removed": "this.removedClass", "attr.tabIndex": "this.tabIndex" } }, providers: [
        ...
        <ng-container
            *ngTemplateOutlet="getActiveBubbleTemplate()?.templateRef; context: { $implicit: message }"
        ></ng-container>
        ...
        >
            <div class="k-bubble-content">
                <ng-container
                    *ngTemplateOutlet="getActiveContentTemplate()?.templateRef; context: { $implicit: message }"
                ></ng-container>
            </div>
        ...
        >
            <div class="k-bubble-content">
                @if (message.text || message.isDeleted) { @if (message.replyToId && !message.isDeleted) {
                <div
                ...
                >
                    <chat-message-reference-content
                        [message]="getMessageById(message.replyToId)"
                    ></chat-message-reference-content>
                </div>
                ...
                } } @if (hasFiles && !message.isDeleted) { @if (chatService.messageFilesLayout === 'vertical' ||
                chatService.messageFilesLayout === 'wrap') {
                <ul
                    class="k-file-box-wrapper"
                    [ngClass]="{
        ...
        } } @if(message.status || (chatService.timestampVisibility === 'focus' && message.timestamp)) {
        <div class="k-message-info">
            @if (message.status) {
            <span class="k-message-status">
                ...
                } @if (!statusTemplate?.templateRef) { @if (isStatusString) {
                {{ message.status }}
                } @else { @if (statusObject?.icon || statusObject?.svgIcon) {
                <kendo-icon-wrapper
                    size="xsmall"
                    [name]="statusObject?.icon"
                    [svgIcon]="statusObject?.svgIcon"
                ></kendo-icon-wrapper>
                }
                {{ statusObject?.text }}
                } }
            ...
            <time [attr.aria-hidden]="!selected" class="k-message-time">
                {{ formatTimeStamp(message.timestamp) }}
            </time>
            }
            @if (message.failed) {
                <span class="k-message-failed-content">
                    <kendo-icon-wrapper
                        size="xsmall"
                        [name]="'warning-triangle'"
                        [svgIcon]="messageFailedIcon"
                    >
                    </kendo-icon-wrapper>
                    <span class="k-message-failed-text">{{ textFor('messageFailedText') }}</span>
                </span>
            }
        </div>
        } } @if (showToolbar) {
...
class MessageListComponent {
    ...
    onBlur(args) {
        ...
        const isActionClick = closest(next, (node) => node?.classList?.contains('k-context-menu-popup')) ||
            closest(next, (node) => node?.classList?.contains('k-menu-popup'));
    ...
    select(item, event) {
        if (event) {
            const target = event.target;
            if (target.classList.contains('k-suggestion') ||
                target.closest(DOWNLOAD_ALL_SELECTOR) ||
                target.closest(FILE_ACTION_BTN_SELECTOR)) {
                return;
            }
        }
        if (!this.chatService.toggleMessageState) {
    ...
    onTabKeyDown(event) {
        ...
        const isLastItemQuickReply = lastItem instanceof SuggestedActionsComponent;
        if (!lastItem || this.selectedItem === lastItem) {
            return;
        }
        if (isLastItemQuickReply) {
            event.target.blur();
        ...
        >
            ...
            <div class="k-avatar">
                <span class="k-avatar-image">
                    <img [attr.src]="group.author.avatarUrl" [alt]="group.author.avatarAltText" />
                </span>
            </div>
            ...
            <div class="k-message-group-content">
                ...
                @if (msg.attachments && msg.attachments.length === 1) {
                <kendo-chat-attachment [attachment]="msg.attachments[0]" [template]="attachmentTemplate">
                </kendo-chat-attachment>
                } }
            </div>
        </div>
...
class ScrollAnchorDirective {
    ...
    onScroll() {
        ...
        if (autoScrollChanged || buttonChanged) {
            this.zone.run(() => {
                ...
                if (buttonChanged) {
                    this.showScrollToBottomButton = showScrollButton;
                    this.cdr.markForCheck();
                }
            });
        }
    ...
    calculateMessageBoxSeparator() {
        ...
        if (this.showMessageBoxSeparator !== shouldShow) {
            this.showMessageBoxSeparator = shouldShow;
            this.cdr.markForCheck();
        }
    }
    setupScrollUpdate() {
        ...
        this.scrollUpdate = requestAnimationFrame(() => {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.18", ngImport: i0, type: ScrollAnchorDirective, deps: [{ token: i0.ElementRef }, { token: i0.NgZone }, { token: i0.Renderer2 }, { token: i0.ChangeDetectorRef }], target: i0.ɵɵFactoryTarget.Directive });
...
class ChatComponent {
    ...
    ngOnInit() {
        ...
        this.subs.add(this.chatService.resendMessage$.subscribe((event) => {
            this.resendMessage.emit(event);
        }));
    ...
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "19.2.18", type: ChatComponent, isStandalone: true, selector: "kendo-chat", inputs: { messages: "messages", authorId: "authorId", messageBoxType: "messageBoxType", height: "height", width: "width", placeholder: "placeholder", messageWidthMode: "messageWidthMode", timestampVisibility: "timestampVisibility", showUsername: "showUsername", showAvatar: "showAvatar", allowMessageCollapse: "allowMessageCollapse", speechToTextButton: "speechToTextButton", fileSelectButton: "fileSelectButton", messageBoxSettings: "messageBoxSettings", messageToolbarActions: "messageToolbarActions", inputValue: "inputValue", authorMessageSettings: "authorMessageSettings", receiverMessageSettings: "receiverMessageSettings", messageContextMenuActions: "messageContextMenuActions", fileActions: "fileActions", messageFilesLayout: "messageFilesLayout", suggestionsLayout: "suggestionsLayout", quickActionsLayout: "quickActionsLayout", suggestions: "suggestions", sendButtonSettings: "sendButtonSettings", modelFields: "modelFields", scrollToBottomButton: "scrollToBottomButton", loading: "loading" }, outputs: { sendMessage: "sendMessage", resendMessage: "resendMessage", toolbarActionClick: "toolbarActionClick", contextMenuActionClick: "contextMenuActionClick", fileActionClick: "fileActionClick", download: "download", executeAction: "executeAction", suggestionExecute: "suggestionExecute", fileSelect: "fileSelect", fileRemove: "fileRemove", unpin: "unpin", inputValueChange: "inputValueChange" }, host: { properties: { "class": "this.className", "attr.dir": "this.dirAttr" } }, providers: [
        ...
        <ng-container
            ...
            i18n-deletedMessageSenderText="
                kendo.chat.deletedMessageSenderText|The text that is displayed when the sender deletes a message
            "
            deletedMessageSenderText="You removed this message."
            i18n-deletedMessageReceiverText="
                kendo.chat.deletedMessageReceiverText|The text that is displayed when the receiver deletes a message
            "
            deletedMessageReceiverText="This message was removed by its sender."
            i18n-messageFailedText="kendo.chat.messageFailedText|The text that is displayed when the message has failed to send"
            ...
            i18n-messageBoxTitle="kendo.chat.messageBoxTitle|Sets the aria-label for the input/textarea element."
            messageBoxTitle="Message"
            i18n-actionButtonTitle="kendo.chat.actionButtonTitle|The text for the Action button"
            ...
            i18n-messageAttachmentLeftArrow="
                kendo.chat.messageAttachmentLeftArrow|The text for the left arrow of the message attachments
            "
            messageAttachmentLeftArrow="Previous item"
            i18n-messageAttachmentRightArrow="
                kendo.chat.messageAttachmentRightArrow|The text for the right arrow of the message attachments
            "
            ...
            i18n-removeReplyTitle="
                kendo.chat.removeReplyTitle|Sets the title of the icon which removes the reply reference in the Message
                Box.
            "
            removeReplyTitle="Remove reply"
            i18n-removeFileTitle="
                kendo.chat.removeFileTitle|Sets the title of the icon which removes a selected file in the Message Box.
            "
            removeFileTitle="Remove file"
            i18n-expandTitle="
                kendo.chat.expandTitle|Sets the title of the icon which demonstrates that the message can be expanded.
            "
            expandTitle="Expand message"
            i18n-collapseTitle="
                kendo.chat.collapseTitle|Sets the title of the icon which demonstrates that the message can be
                collapsed.
            "
            collapseTitle="Collapse message"
            i18n-fileActionsTitle="
                kendo.chat.fileActionsTitle|Sets the title of the DropDownButton which opens the File actions.
            "
            fileActionsTitle="File actions"
            i18n-downloadAllFilesText="
                kendo.chat.downloadAllFilesText|Sets the text that is displayed in the download section of the message.
            "
            downloadAllFilesText="Download all"
            i18n-previousSuggestionsButtonTitle="
                kendo.chat.previousSuggestionsButtonTitle|The title of the button that scrolls to the previous
                suggestions
            "
            previousSuggestionsButtonTitle="Scroll left"
            i18n-nextSuggestionsButtonTitle="
        ...
        <div class="k-chat-header k-toolbar">
        ...
        >
            ...
            <div class="k-message-list-content k-message-list-content-empty">
                <ng-template [ngTemplateOutlet]="chatNoDataTemplate?.templateRef"> </ng-template>
            </div>
            } @else {
            ...
            } @if (scrollToBottomButton && anchor.showScrollToBottomButton) {
            <div class="k-chat-scroll-to-bottom-container">
                <kendo-floatingactionbutton
        ...
        @if (anchor.showMessageBoxSeparator) {

 ...
 * * `let-state`&mdash;A reference to the current state of each file. If the [`batch`](https://www.telerik.com/kendo-angular-ui/components/uploads/api/uploadcomponent#batch) option of the Upload is set to `true`, the field reflects the state of the whole batch.
